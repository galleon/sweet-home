...
JOB_NAME=house_training_$(shell date +'%Y%m%d_%H%M%S')

run_locally:
	python -m ${PACKAGE_NAME}.${FILENAME} \
		--data gs://${BUCKET_NAME}/${BUCKET_DATA_FOLDER}/${DATA_FILE}
...
gcp_submit_training:
	gcloud ai-platform jobs submit training ${JOB_NAME} \
		...
		--region ${REGION} \
		--stream-logs -- --data gs://${BUCKET_NAME}/${BUCKET_DATA_FOLDER}/${DATA_FILE}
